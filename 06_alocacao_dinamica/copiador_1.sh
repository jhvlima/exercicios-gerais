...
dest_dir="02_TAD_dinamico/TAD_pont_" #<coloca o radical da atividade aqui, no diretorio 05_ponteiros seria "pont_"
...
start_dest=1
end_dest=8 #coloca a quantidade de atividades
#################################################################################################

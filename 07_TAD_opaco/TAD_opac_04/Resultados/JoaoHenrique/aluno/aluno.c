...
{ 
    ...
    //aluno->nome = malloc(TAM_INICIAL_NOME * sizeof(char));
    aluno->n1 = -1;
    aluno->n2 = -1;
    aluno->n3 = -1;
    aluno->matricula = -1;
 ...
 *
 * @param aluno Ponteiro para aluno (alocado dinamicamente), cujos dados serão preenchidos nessa função
 */
